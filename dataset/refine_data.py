...
def refine_single_data(schema: str, natural_query: int, sql_query: int) -> int:
...
def refine_data(data_path: str, outupt_data_path:str) -> pd.DataFrame:
    ...
    result.columns = ["schema", "sql_query", "natural_language_query"]
